...
const AWSCredentials = {
  ...
  bucketName: "invoice-lb/generated-counselling-report",
};
...
export default async function counsellingReportPdfGenerate(req, res) {
  ...
  const uploadToS3 = (fileName) => {
    ...
    const fileContent = fs.readFileSync(
      `./public/counsellingReportPdf/${fileName}`
    );
  ...
  if (transitionDomain === "Sales") {
    point1 =
      "BMW: Forecasting future sales with trends and price maximization.";
    point2 = "Amazon: Fact based cross-sell recommendation. ";
    point3 = "Starbucks: Maximization of customer lifetime value (CLV)";
    point4 =
      "Flipkart: Automated sentiment analysis to get real-time actionable insight in one click.";
  }
  if (transitionDomain === "Marketing") {
    point1 =
      "Swiggy: Descriptive study of trends and irregularities with prediction analysis for conversion.";
    point2 =
      "Spotify: Analysis of the market basket to increase marketing message efficiency.";
    point3 =
      "DropBox: Building a proficient site analyzer for customer lifetime value analysis.";
    point4 =
      "Mcdonald's: Analysis of consumer personality based on potential customer's buying behaviors";
  }
  if (transitionDomain === "HR") {
    point1 =
      "IBM: Career progression planning of  employees with workforce defections & efficiency.";
    point2 =
      "ITC: Future proof and cost-effective workforce planning and analytics.";
    point3 =
      "SAP: Automated analysis of talent's maturity level to identify the most suitable candidate.";
    point4 =
      "Juniper Networks: Progression analysis and recurrence demands of the organization.";
  }
  if (transitionDomain === "BFSI") {
    point1 =
      "JP Morgan: Learn and develop classification techniques for digital transformation.";
    point2 =
      "IDFC: A crisp financial product recommendation system generation.";
  ...
  if (transitionDomain === "Healthcare") {
    point1 =
      "Qiagen: Preparing a system that can quickly read and identify complex gene structures.";
    point2 =
      "McKesson Corporation: Early prediction of depression, anxiety, and stress-related diseases.";
    point3 =
      "Apollo Pharmacy: Building personalized medication programs based on genomic sequencing.";
    point4 =
      "Bayer: Enhancing disease monitoring and prevention based on exploratory data analytics.";
  }
  if (transitionDomain === "Retail & E-commerce") {
    point1 =
      "Ikea: Enhance customer service through the use of natural language processing.";
    point2 =
      "Shopify: Utilizing ML customer segmentation technique to evaluate price optimization.";
    point3 =
      "DataCo: Automated inventory monitoring for supportable supply chain management.";
    point4 =
      "Adani Wilmar: Analytics-based approaches boost customer engagement and loyalty.";
  }
  if (transitionDomain === "Media and Hospitality") {
    point1 =
      "Twitter: Distribution of content on social media by analyzing user behavior.";
    point2 =
      "Buzz Feed: Using statistics from popular YouTube videos to gain deeper insights";
    point3 =
      "Airbnb: Analyzing information about public reputation data based on web reviews";
    point4 =
      "Orbitz: Get a better understanding of Hotel Energy Consumption  Management through IoT";
  }
  if (transitionDomain === "Transportation") {
    point1 =
      "FedEx: A Semi-Supervised Deep Learning Approach for Identification of Transportation Modes Using GPS-Derived Data.";
    point2 =
      "Ola: Reduction of waiting time via a highly precise forecasting model.";
    point3 =
      "Tesla: Analyzing Road safety management through predictive analysis.";
    point4 =
      "Honeywell International: Enhancement of the air traffic management system through the use of modern data analytics.";
  }

  if (transitionDomain === "Manufacturing") {
    point1 =
      "Bosch: Condition-based preventive maintenance and fault prediction in depth ";
    point2 =
      "Cannon: Identifying the technique of warranty analysis methodology with data analytics";
    point3 =
      "Nestle: Utilizing data analytics in managing inventories and predicting demand.";
    point4 =
      "Hitachi Engineering: Leveraging the use of data science techniques for product development and design";
  }
  if (transitionDomain === "Automotive") {
    point1 = "Toyota: Automotive sustainability development via ML.";
    point2 =
      "L&T: Improve quality assurance and minimize liability with early detection of malfunctions.";
    point3 =
      "Crestron: Investigating the creation of smart factories through automation and robotics.";
    point4 =
      "Fiat: Combining big data and automation in Designing and Developing the maximum possible efficient Product.";
  }
  if (transitionDomain === "Telecommunication") {
    point1 =
      "Jio: Churn forecasting for the telecom industry using R programming with ML.";
    point2 =
      "Globe Technologies: Enabling real-time location-based advertising.";
    point3 =
      "Lumen: Using historical data analysis, create a better network security structure.";
    point4 =
      "Swisscom: Understanding and detecting fraud using machine learning algorithms.";
  }
  if (transitionDomain === "Energy, Oil & Gas") {
    point1 =
      "Ather Energy: Creating a dynamic energy management system to conserve electricity and energy.";
    point2 =
      "Saudi Aramco: Understanding in-depth logging while drilling (LWD) technique.";
    point3 =
      "Repsol: Developing predictive and preventive measures based on live and historically analyzed data";
    point4 =
      "TotalEnergies: Integrating the use of Data Analytics in reservoir engineering";
  }
  ...
  try {
    ...
    const pdfName =
      "[Personalized Career Counselling Report]" +
      stdName +
      new Date() +
      "-" +
      counsellingId;
